...
<section class="pt-16 pb-10">
	<Container>
		<div class="grid items-center gap-10 lg:grid-cols-2">
			<div>
				<p class="text-sm font-medium opacity-70">Backend • Java • Spring Boot</p>
				...
				<div class="mt-7 flex flex-wrap gap-3">
					<a href="#projects" class="btn-primary rounded-xl border px-4 py-2 text-sm font-medium"
						>View Projects</a
					>
					<a
						href="#contact"
						class="btn-glass rounded-xl border px-4 py-2 text-sm font-medium"
						>Get in touch</a
					>
				</div>

				<div class="mt-8 flex flex-wrap gap-2">
					<span class="glass rounded-full border px-3 py-1 text-xs opacity-80">Open to work</span>
					<span class="glass rounded-full border px-3 py-1 text-xs opacity-80">Debrecen / Remote</span>
					<span class="glass rounded-full border px-3 py-1 text-xs opacity-80">Spring • Java • C#</span>
				</div>
			</div>
			...
			<div class="grid gap-4">
				...
				<div class="grid gap-4 sm:grid-cols-3">
					<div class="glass rounded-2xl border-2 p-5">
